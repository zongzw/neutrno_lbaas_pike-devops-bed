...
class LoadBalancerPluginDbv2(base_db.CommonDbMixin,
    ...
    def _convert_api_to_db(self, listener):
        ...
        if 'client_ca_tls_container_ref' in listener:
            client_ca_tls_cref = listener.get('client_ca_tls_container_ref')
            del listener['client_ca_tls_container_ref']
            listener['client_ca_tls_container_id'] = client_ca_tls_cref
        if 'client_crl_container_ref' in listener:
            client_crl_cref = listener.get('client_crl_container_ref')
            del listener['client_crl_container_ref']
            listener['client_crl_container_id'] = client_crl_cref
