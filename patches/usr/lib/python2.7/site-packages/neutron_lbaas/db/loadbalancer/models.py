...
class LoadBalancer(model_base.BASEV2, model_base.HasId, model_base.HasProject):
    ...
    operating_status = sa.Column(sa.String(16), nullable=False)
    admin_state_up = sa.Column(sa.Boolean(), nullable=False)
    flavor = sa.Column(sa.Integer, nullable=False)
...
class Listener(model_base.BASEV2, model_base.HasId, model_base.HasProject):
    ...
    name = sa.Column(sa.String(255))
    customized = sa.Column(sa.String(1024))
    description = sa.Column(sa.String(255))
    ...
    mutual_authentication_up = sa.Column(sa.Boolean(), nullable=False)
    ca_container_id = sa.Column(sa.String(128),
                                default=None, nullable=True)
    tls_protocols = sa.Column(sa.String(255))
    cipher_suites = sa.Column(sa.String(4095))
    ...
    http2 = sa.Column(sa.Boolean(), nullable=False)
    protocol_port = sa.Column(sa.Integer, nullable=False)
    connection_limit = sa.Column(sa.Integer)
    admin_state_up = sa.Column(sa.Boolean(), nullable=False)
    transparent = sa.Column(sa.Boolean(), nullable=True)
    provisioning_status = sa.Column(sa.String(16), nullable=False)
    operating_status = sa.Column(sa.String(16), nullable=False)
