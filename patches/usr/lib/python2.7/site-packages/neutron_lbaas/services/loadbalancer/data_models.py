...
class SessionPersistence(BaseDataModel):
    ...
    fields = ['pool_id', 'type', 'persistence_timeout', 'cookie_name', 'pool']
...
class Listener(BaseDataModel):
    ...
    fields = ['id', 'tenant_id', 'name', 'description', 'default_pool_id',
              ...
              'mutual_authentication_up', 'ca_container_id', 'customized',
              'tls_protocols', 'cipher_suites', 'http2',
              'sni_containers', 'protocol_port', 'connection_limit',
              'admin_state_up', 'provisioning_status', 'operating_status',
              'default_pool', 'loadbalancer', 'l7_policies', 'transparent']

    def __init__(self, id=None, tenant_id=None, name=None, description=None, customized='',
                 ...
                 mutual_authentication_up=False, ca_container_id=None,
                 tls_protocols=None, cipher_suites=None, http2=False,
                 admin_state_up=None, provisioning_status=None,
                 operating_status=None, default_pool=None, loadbalancer=None,
                 l7_policies=None, transparent=None):
        self.id = id
        self.tenant_id = tenant_id
        self.name = name
...
class LoadBalancer(BaseDataModel):
    ...
    fields = ['id', 'tenant_id', 'name', 'description', 'bandwidth', 'vip_subnet_id',
              'vip_port_id', 'vip_address', 'provisioning_status', 'flavor',
              'operating_status', 'admin_state_up', 'vip_port', 'stats',
              'provider', 'listeners', 'pools', 'flavor_id']

    def __init__(self, id=None, tenant_id=None, name=None, description=None, bandwidth=None,
                 vip_subnet_id=None, vip_port_id=None, vip_address=None,
                 provisioning_status=None, operating_status=None,
                 admin_state_up=None, vip_port=None, stats=None,
                 provider=None, listeners=None, pools=None, flavor_id=None, flavor=None):
        self.id = id
        self.tenant_id = tenant_id
        self.name = name
        self.description = description
